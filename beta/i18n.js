...
window.CCF_I18N = {
  it: {
    ...
    feedback: {
      ...
      error: "Invio non riuscito. Controlla la connessione e riprova: le risposte restano salvate nel browser.",
      invalidEmail: "Controlla l'indirizzo email."
    },
    thanks: {
      title: "Grazie!",
      body: "Il tuo contributo alla validazione del framework è stato registrato.",
  ...
  en: {
    ...
    feedback: {
      ...
      sending: "Sending…",
      error: "Submission failed. Check your connection and try again: your answers remain saved in the browser.",
      invalidEmail: "Please check the email address."
    },
    thanks: {
      title: "Thank you!",
      body: "Your contribution to the validation of the framework has been recorded.",
